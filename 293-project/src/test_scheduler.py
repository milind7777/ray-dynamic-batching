...
class WorkloadGenerator:
    ...
    def __init__(self, scheduler: NexusScheduler, model_patterns: dict = {}, pattern_period: float = 600.0):
            ...
            for model in pattern.keys():
                if pattern[model]['type'] == 'slope':
                    ...
                    for i in range(int(rate)):
                        ...
                        self.scheduler.submit_request(model, str(model) + str(time.time()), input_tensor)
